...
/* WEBPACK VAR INJECTION */(function($) {// core coding by Mapk Volkov
const Photoclip=__webpack_require__(3);
const html2canvas=__webpack_require__(7);
const block=$('#block');
const area=$('#clipArea');
const btn=$('#clipBtn');
const view=$('#view');
...
btn.on('click',()=>{
	...
	can.append(canvas);
	const img=$('#img');
	var a1='https://i4.bbs.fd.zol-img.com.cn/t_s800x5000/g3/M00/0F/06/Cg-4V1EVecyITx3ZAAIWK3zd8ewAAE9BQPBvD8AAhZD894.jpg';
	img.on('load',()=>{
